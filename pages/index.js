  ...
  return (
    <>
      <div className="relative min-h-screen bg-black">
        ...
        {/* Footer */}
        <div className="animate-rise fixed bottom-3 right-0 text-gray-300 bg-dark text-xs p-3 rounded-l-lg">
          <p>
            Powered by{" "}
            <a
            ...
            <div className="mt-4 relative flex items-end text-left h-64">
              {blur ? (
                ...
                <button
                  ...
                  className="left-0 absolute text-white text-left text-2xl sm:text-4xl font-bold mx-auto"
                >
